...
function parseRecords(text) {
    return text.split('\n')
        ...
        .map(function (line) { return Record.parse(line); })
...
var Landns = /** @class */ (function () {
    ...
    Landns.prototype.set = function (records) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios$1.post(this.endpoint, records.filter(function (record) { return record !== null; }).map(function (record) { return record.toString(); }).join('\n'), { headers: { "Content-Type": "text/plain" } })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Landns.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios$1["delete"](this.endpoint + "/id/" + id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Landns.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios$1.get(this.endpoint)];
                    case 1:
                        resp = _a.sent();
    ...
    Landns.prototype.glob = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios$1.get(this.endpoint + "/glob/" + query)];
                    case 1:
                        resp = _a.sent();
                        return [2 /*return*/, parseRecords(resp.data)];
                }
